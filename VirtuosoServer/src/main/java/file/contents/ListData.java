...
public class ListData {
	...
	public static ArrayList<String> listDetailPerson() throws FileNotFoundException {
		listDetailPerson = getFileContents.getListFiles(getPathFile.pathDetailPerson);
		return listDetailPerson;
	}

	/*---------------------------Organization ---------------------*/
	public static ArrayList<String> listOrganization() throws FileNotFoundException {
		listOrganization = getFileContents.getListFiles(getPathFile.pathOrganization);
		return listOrganization;
	}

	public static ArrayList<String> listOrganizationDetail() throws FileNotFoundException {
	...
	/**
	 * Vì số lượng có hạn và mỗi country lại gắn luôn với 1 detail nên ta sẽ ghép
	 * Country với detail luôn
	 * 
	 * @return
	 */
	public static ArrayList<Country> country() throws FileNotFoundException {
	...
	/*----------------------------Event----------------------------------*/
	public static ArrayList<String> listEvent() throws FileNotFoundException {
		listEvent = getFileContents.getListFiles(getPathFile.pathEvent);
		return listEvent;
	}

	public static ArrayList<String> listEventDetail() throws FileNotFoundException {
	 ...
	 * @return
	 */
	private static String time() throws FileNotFoundException {
	...
	/*----------------------------Relationship----------------------------*/
	public static ArrayList<String> listRelatioship() throws FileNotFoundException {
