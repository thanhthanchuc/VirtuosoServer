...
public class getPathFile {
	...
	protected static final String pathEmainDetail = "src/main/java/file/CountryDetail/Covania.txt";
	protected static final String pathOgriaDetail = "src/main/java/file/CountryDetail/Emain.txt";
	protected static final String pathOmenDetail = "src/main/java/file/CountryDetail/Omen.txt";
	protected static final String pathOsiumDetail = "src/main/java/file/CountryDetail/Osium.txt";
	protected static final String pathOxtradDetail = "src/main/java/file/CountryDetail/Oxtrad.txt";
	protected static final String pathToriaDetail = "src/main/java/file/CountryDetail/Toria.txt";
	protected static final String pathUderDetail = "src/main/java/file/CountryDetail/Udor.txt";
	protected static final String pathUsaDetail = "src/main/java/file/CountryDetail/USA.txt";
	protected static final String pathVietnamDetail = "src/main/java/file/CountryDetail/Vietnam.txt";
}
